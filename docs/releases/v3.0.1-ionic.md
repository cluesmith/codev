...
- **VS Code Extension**: A first-class IDE companion to the browser Tower UI, [available now on the Marketplace](https://marketplace.visualstudio.com/items?itemName=cluesmith.codev-vscode)
...
- **Available on the Marketplace** as `cluesmith.codev-vscode`

Install:

```bash
code --install-extension cluesmith.codev-vscode
```

Or search "Codev for VS Code" in the Extensions panel and click **Install**.
...
Or install [from the Marketplace](https://marketplace.visualstudio.com/items?itemName=cluesmith.codev-vscode).
