...
- **Protocol-agnostic spawn**: `afx spawn` works with any protocol
...
### CLI Improvements
- `afx tower connect` / `afx tower disconnect` (renamed from register/deregister, aliases preserved)
- `afx spawn --resume` to resume existing porch state
- `afx attach` command for connecting to builder terminals
