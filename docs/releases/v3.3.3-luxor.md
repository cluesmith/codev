...
- **Mohid Makhdoomi (@mohidmakhdoomi)** — the delivery-integrity core of this
  ...
  on his 3.3.2 serializer work at the terminal write edge.
...
- **Amr Elsayed (@amrmelsayed)** — release hardening, live verification, and
  ...
  field-verification campaign on the delivery stack (#1564).
