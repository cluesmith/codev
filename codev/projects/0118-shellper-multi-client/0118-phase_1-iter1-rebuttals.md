...
1. **Only Tower connects to shellper today** — there are no terminal clients yet (Phase 2 adds `afx attach`). So any existing client without `clientType` IS a tower.
