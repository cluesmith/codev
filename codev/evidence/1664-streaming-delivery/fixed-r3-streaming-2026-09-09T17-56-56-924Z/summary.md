# Issue #1664 — streaming delivery acceptance (fixed-r3)
...
- longest output gap seen while a row waited: 346 ms (the retired whole-screen settle needed 250 ms to deliver at all)
- wait to delivery: mean 394 ms, median 393 ms, max 396 ms
