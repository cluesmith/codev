# Issue #1664 — streaming delivery acceptance (fixed)
...
- delivered at a moment the RETIRED whole-screen settle would have refused: 18/20
- longest output gap seen while a row waited: 335 ms (the retired whole-screen settle needed 250 ms to deliver at all)
- wait to delivery: mean 374 ms, median 397 ms, max 400 ms
...
- repaints the recipient emitted while the row waited: median 4
