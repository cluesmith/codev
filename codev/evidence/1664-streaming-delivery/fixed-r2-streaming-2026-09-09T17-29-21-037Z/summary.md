# Issue #1664 — streaming delivery acceptance (fixed-r2)
...
- longest output gap seen while a row waited: 331 ms (the retired whole-screen settle needed 250 ms to deliver at all)
- wait to delivery: mean 395 ms, median 395 ms, max 399 ms
