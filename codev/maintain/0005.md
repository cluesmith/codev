...
37fab10 [Spec 0065] Implement afx spawn --issue and afx cleanup --issue
...
1. **BUGFIX Protocol** (Spec 0065)
   ...
   - CLI support: `afx spawn --issue N`, `afx cleanup --issue N`
...
| CLI Commands | Updated | Added `afx spawn --issue`, `afx cleanup --issue` |
...
- Gemini's concerns about `codev import`, `generate-image`, and SPIR protocol are NOT from this PR
...
- BUGFIX protocol added (afx spawn --issue, afx cleanup --issue)
