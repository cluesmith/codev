...
7c04fa8 [Spec 0053] afx open image support
```
...
- [x] Extracted `renderActivityContentHtml(data, options)` to `utils.js` - consolidates activity rendering from activity.js
- [x] Updated main.js, files.js, dialogs.js, tabs.js, activity.js to use shared utilities
...
| Activity rendering | 45 min | ✅ **COMPLETED** - Extracted to `utils.js` |
...
- Dashboard `formatTime`: Duplicate inline definitions in activity.js
...
- **Dashboard JS Deduplication** (3 clusters):
  - `utils.js`: openFileTab, handleMenuKeydown, renderActivityContentHtml
  - Updated main.js, files.js, dialogs.js, tabs.js, activity.js
